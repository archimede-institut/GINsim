...
public class SATExportConfigPanel extends AbstractStackDialogHandler {
	...
	JTextArea area;
	private GsSATConfigModel model;
	private GsSATMutantModel mutantModel;
	...
	protected void init() {
		...
		jrbType2 = new JRadioButton(Translator.getString("STR_SAT_Type2"));
	...
	public void changeExportType() {
		int type = (jrbType2.isSelected()) ? SATConfig.CFG_SCC
 ...
 */
class GsSATConfigModel extends AbstractTableModel {
	private static final long serialVersionUID = 7422246174951281931L;
	 ...
	 * @param initstates
	 */
	public GsSATConfigModel(Vector<RegulatoryNode> nodeOrder,
			Map<RegulatoryNode, Integer> m_initstates) {
...
class GsSATMutantModel extends DefaultComboBoxModel implements ComboBoxModel {
	private static final long serialVersionUID = -3722285323695000849L;

	RegulatoryMutants listMutants;
	SATConfig cfg;

	GsSATMutantModel(SATConfig cfg) {
		this.cfg = cfg;
