...
/**
 * OverviewPanel provides a 'birds-eye' view of a jgraph based graph.
...
public class OverviewPanel
	...
	private static final long serialVersionUID = 356487696480L;
	protected GsJgraph graph;
	...
	/** OverviewPanel provides a 'birds-eye' view of the active document. 
	...
	protected OverviewPanel(Graph<?, ?> g, JGraph jg, JGraphModelAdapter<?,?> ma, JScrollPane sp) {
        ...
        originalGraph.addPropertyChangeListener(JGraph.SCALE_PROPERTY, v);
	...
	/** OverviewPanel factory that returns instance with small inset as a buffer.
	 * @param g
	 * @param sp
	...
	protected class ViewRedirector extends GraphLayoutCache {

		private static final long serialVersionUID = 5648690875490564L;
		protected GraphLayoutCache realView;

		protected ViewRedirector(GraphLayoutCache realView) {
    ...
    protected class EventProxy extends Thread implements MouseListener {

        private boolean pushed = false;
        private PannerViewfinder panner;

        protected EventProxy(PannerViewfinder viewfinder) {
            this.panner = viewfinder;
        }
	...
	protected class PannerViewfinder
		implements MouseListener, MouseMotionListener, PropertyChangeListener, ChangeListener {
	    protected final int LEFT_VERTICAL = 1;
	    protected final int RIGHT_VERTICAL = 2;
	    protected final int UPPER_HORIZONTAL = 4;
	    protected final int LOWER_HORIZONTAL = 8;
	    protected final int NW_CORNER = 5;
	    protected final int NE_CORNER = 6;
	    protected final int SW_CORNER = 9;
	    protected final int SE_CORNER = 10;
		...
		protected PannerViewfinder(Container c, JScrollPane sp) {
			this.container = c;
			this.viewport = sp.getViewport();
            proxy = new EventProxy(this);
            sp.getHorizontalScrollBar().addMouseListener(proxy);
            sp.getVerticalScrollBar().addMouseListener(proxy);
...
//				container.repaint();
		...
		protected void synchViewportWithPanner() {
		...
		protected void updatePannerLocation(MouseEvent e) {
