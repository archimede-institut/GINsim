...
public class HTGSimulationQueueSCC implements HTGSimulationQueueItem {
	...
	/* (non-Javadoc)
	 * @see org.ginsim.gui.service.tool.reg2dyn.HTGSimulationQueueItem#toString()
	 */
	...
	/* (non-Javadoc)
	 * @see org.ginsim.gui.service.tool.reg2dyn.HTGSimulationQueueItem#setIndex(int)
	 */
	...
	/* (non-Javadoc)
	 * @see org.ginsim.gui.service.tool.reg2dyn.HTGSimulationQueueItem#getIndex()
	 */
	public int getIndex() {
		return index;
	}
	...
	/* (non-Javadoc)
	 * @see org.ginsim.gui.service.tool.reg2dyn.HTGSimulationQueueItem#setLow_index(int)
	 */
	...
	/* (non-Javadoc)
	 * @see org.ginsim.gui.service.tool.reg2dyn.HTGSimulationQueueItem#getLow_index()
	 */
	...
	/* (non-Javadoc)
	 * @see org.ginsim.gui.service.tool.reg2dyn.HTGSimulationQueueItem#setState(byte[])
	 */
	...
	/* (non-Javadoc)
	 * @see org.ginsim.gui.service.tool.reg2dyn.HTGSimulationQueueItem#getState()
	 */
	...
	/* (non-Javadoc)
	 * @see org.ginsim.gui.service.tool.reg2dyn.HTGSimulationQueueItem#containsState(byte[])
	 */
