...
/**
 * UI for the animator plugin. it helps you contructing a path on the dynamic
 * graph and to run/export the animation.
 */
public class GsAnimatorUI extends JDialog {

	private static final long serialVersionUID = -603747997597648387L;

	private JList pathList = null;

	private GsRegulatoryAnimator pathModel;
	 ...
	 * @param animator
	 */
	public GsAnimatorUI(JFrame frame, GsRegulatoryAnimator animator) {
		super(frame);
		pathModel = animator;
		initialize();
	}
	...
	/**
	 * inform the user that the animator is playing. (with a pause like button:
	 * "||")
	 */
	...
	/**
	 * inform the user that the animator is ready to play. (with a play like
	 * button: "|>")
	 */
