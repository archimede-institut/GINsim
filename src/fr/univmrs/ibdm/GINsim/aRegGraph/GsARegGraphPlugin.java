...
/**
 * register the aRegGraph plugin: animate the regulatory graph according to a
 * path in the associated state transition graph.
 */
public class GsARegGraphPlugin implements GsPlugin, GsActionProvider {
	...
	public GsPluggableActionDescriptor[] getT_action(int actionType,
		...
		if (t_action == null) {
			...
			t_action[0] = new GsPluggableActionDescriptor("STR_aRegGraph",
					"STR_aRegGraph_descr", null, this, ACTION_ACTION, 0);
		}
		return t_action;
	}
