...
public class StatefulLogicalModelImpl extends LogicalModelImpl implements StatefulLogicalModel {
	 ...
	 */
	public StatefulLogicalModelImpl(LogicalModel model, List<byte[]> states, String name) {
		this(model.getMDDManager(), model.getComponents(), model.getLogicalFunctions(), model.getExtraComponents(), model.getExtraLogicalFunctions(), states, name);
	}
