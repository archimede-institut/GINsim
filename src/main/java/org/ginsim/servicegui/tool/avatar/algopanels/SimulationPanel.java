...
/**
 * Class for managing the panel with the parameters of a simulation (e.g. Avatar, Firefront and MonteCarlo panels).<br>
...
public abstract class SimulationPanel extends JPanel {
	 ...
	 */
	public SimulationPanel(Icon img, boolean flex){
		flexible = flex;
		helpImg = img;
	}
	 ...
	 * @param model the stateful logical model possibly defining a set of initial states and oracles
	 * @param plots whether charts should be created and plotted 
	 * @param quiet whether detailed logs of the behavior of the simulation are to be printed (default: true)
	 ...
	 * @param param the set of parameters to be read for populating the panel
	 */
	 ...
	 * @param param the set of parameters to be populated
	 */
