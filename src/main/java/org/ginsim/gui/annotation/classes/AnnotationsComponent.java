 ...
 */
public class AnnotationsComponent<T> extends JSplitPane {
	private static final long serialVersionUID = 1L;

	private final Annotator<T> annotator;

	JButton cur_qualifier = new JButton("Add group");
	...
	private JPanel setupAnnotationPanel() {
		...
		// Add two textfield and a button to create new annotation blocks
...
//	private ArrayList<String> indexQualifiers = new ArrayList<>();
//	private Map<JPanel, QualifierProperties> caracsQualifiers = new HashMap<>();
////	private Map<String, AnnotationType> typeQualifiers = new HashMap<>();
...
//				try {
//			        if (creation) {
//			        	this.metadata.addDateString(qualifier, bricks.get(1));
//		        	}
//
...
//	}
//
//	private AnnotationType getTypeQualifier(String qualifier) {
//		return this.metadata.getAnnotationType(qualifier);
//	}
//
...
//    				"The qualifier "+qualString+" is not used in any "+metadata.getTargetType()+" anymore. Its blocs are removed so that its type can be redefined.", "Information Message",
...
//    			} else if (!getTypeQualifier(qualifier).equals(AnnotationType.Generic)) {
...
//							}
//			    		} else {
//				    		AnnotationType typeAsked = getTypeQualifier(qualifier);
//
...
//				    		} else {
//				    			JOptionPane.showMessageDialog(null,
//				    				"Error: This qualifier is of type "+typeAsked+" not of type "+typeGiven+" for a "+metadata.getTargetType()+".", "Error Message",
...
//
//					try {
//						if (metadata.isAnnotationEmpty(qualString, altInt)) {
...
//
//			final JTextField textValue = new JTextField(30);
//			SuggestionDropDownDecorator.decorate(textValue,
//					new TextComponentSuggestionClient(this::getElementsSuggestions));
//
//			innerPaneCreation.add(textValue);
//
//            EventQueue.invokeLater(new Runnable() {
//	        	@Override
//	        	public void run() {
