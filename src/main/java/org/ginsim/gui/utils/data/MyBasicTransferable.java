 ...
 */
public class MyBasicTransferable implements Transferable, UIResource {
    ...
    static {
        try {
            ...
            System.err.println("error initializing the BasicTranserable");
        }
    }

    public MyBasicTransferable(String plainData, String htmlData) {
